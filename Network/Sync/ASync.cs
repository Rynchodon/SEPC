...
namespace Rynchodon.Utility.Network
{
    ...
    public abstract class ASync
    {
        ...
        protected static MyConcurrentPool<StringBuilder> StringBuilderPool = new MyConcurrentPool<StringBuilder>();

        private static bool _hasValues;
        private static Dictionary<Id, ASync> Syncs;
        ...
        public static SyncBuilder GetBuilder()
        {
            ...
            foreach (KeyValuePair<Id, ASync> idSync in Syncs)
        ...
        public static void SetBuilder(SyncBuilder builder)
        {
            ...
            for (int position = 0; position < builder.Data.Length;)
            {
                ...
                ASync sync;
                if (!Syncs.TryGetValue(id, out sync))
        ...
        {
            return Syncs.TryGetValue(id, out sync);
        }
        ...
        private static void HandleValue(byte[] message, int position)
        {
            ...
            try
            {
                ...
                ASync instance;
                if (!Syncs.TryGetValue(id, out instance))
                {
        ...
        private static void HandleRequest(byte[] message, int position)
        {
            ...
            try
            {
                ...
                foreach (ASync termSync in Syncs.Values)
